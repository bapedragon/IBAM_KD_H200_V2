#!/usr/bin/env python3
"""Run the Table 4 token-space cross-attention control on CIFAR-100."""
...
from methods.Ours.table4_token_space.model import TokenSpaceOurs


PROTOCOL_DEFAULTS = (
    ("--protocol-name", "table4_token_space_cifar100_researcher_sync_v1"),
    ("--student-epochs", "300"),
    ("--batch-size", "64"),
    ("--eval-batch-size", "200"),
    ("--lr", "0.0005"),
...
if __name__ == "__main__":
    ...
    print(
        ...
        "draft_token_space_top1=79.80% "
        "only_change=grid_to_token_space_cross_attention",
        flush=True,
    )
    core.Ours = TokenSpaceOurs  # type: ignore[assignment]
    core.cli_main()
