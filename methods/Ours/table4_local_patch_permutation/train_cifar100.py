#!/usr/bin/env python3
"""Run the Table 4 within-window local patch permutation control."""
...
LOCAL_PATCH_SIZE = 2
PROTOCOL_DEFAULTS = (
    ("--protocol-name", "table4_local_patch_cifar100_researcher_sync_v1"),
    ("--student-epochs", "300"),
    ("--batch-size", "64"),
    ("--eval-batch-size", "200"),
    ("--lr", "0.0005"),
...
def build_local_patch_ours(
    *args: object,
    **kwargs: object,
) -> LocalPatchPermutedOurs:
    return LocalPatchPermutedOurs(
        *args,
...
if __name__ == "__main__":
    ...
    print(
        ...
        "reference_global_same_kv_top1=81.79% "
        "only_change=within_window_local_spatial_permutation "
        "window=2x2 permutation_seed=1 K_equals_V=True",
        flush=True,
    )
    core.Ours = build_local_patch_ours  # type: ignore[assignment]
    core.cli_main()
