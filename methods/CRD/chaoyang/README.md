...
```bash
python methods/CRD/chaoyang/train.py --timing-run --data-dir /app/data/chaoyang --num-workers 4
python methods/CRD/chaoyang/train.py --student-epochs 100 --data-dir /app/data/chaoyang --num-workers 4 --run-name crd_chaoyang_deit_ti_100ep --output-dir /app/output
```
